...
const procedureRegistry = {
  "me": ["query", typedProcedureResolver(api["func"]["session"]["me"], () => (require("../../func/session") as Record<string, unknown>)["me"])],
} as const;
...
export function createFuncSessionCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
): GeneratedProcedureCaller<TCtx> {
  return createCallerFromRegistry(ctx) as GeneratedProcedureCaller<TCtx>;
}

export function createFuncSessionHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
