...
const procedureRegistry = {
  "page": ["query", typedProcedureResolver(api["func"]["tanstackTableDemo"]["page"], () => (require("../../func/tanstackTableDemo") as Record<string, unknown>)["page"])],
} as const;
...
export function createFuncTanstackTableDemoCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
): GeneratedProcedureCaller<TCtx> {
  return createCallerFromRegistry(ctx) as GeneratedProcedureCaller<TCtx>;
}

export function createFuncTanstackTableDemoHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
