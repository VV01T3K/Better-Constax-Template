...
export function createFuncPaginationDemoCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
): GeneratedProcedureCaller<TCtx> {
  return createCallerFromRegistry(ctx) as GeneratedProcedureCaller<TCtx>;
}

export function createFuncPaginationDemoHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
