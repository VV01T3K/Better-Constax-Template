...
const procedureRegistry = {
  "generateUploadUrl": ["mutation", typedProcedureResolver(api["func"]["files"]["generateUploadUrl"], () => (require("../../func/files") as Record<string, unknown>)["generateUploadUrl"])],
  "getServeInfo": ["query", typedProcedureResolver(internal["func"]["files"]["getServeInfo"], () => (require("../../func/files") as Record<string, unknown>)["getServeInfo"])],
  "list": ["query", typedProcedureResolver(api["func"]["files"]["list"], () => (require("../../func/files") as Record<string, unknown>)["list"])],
  "remove": ["mutation", typedProcedureResolver(api["func"]["files"]["remove"], () => (require("../../func/files") as Record<string, unknown>)["remove"])],
  "saveFile": ["mutation", typedProcedureResolver(api["func"]["files"]["saveFile"], () => (require("../../func/files") as Record<string, unknown>)["saveFile"])],
} as const;
...
export function createFuncFilesCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
): GeneratedProcedureCaller<TCtx> {
  return createCallerFromRegistry(ctx) as GeneratedProcedureCaller<TCtx>;
}

export function createFuncFilesHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
