...
export const Route = createFileRoute("/demo/legacy/start/ssr/")({
		...
		>
			<div className="w-full max-w-2xl rounded-xl border-8 border-black/10 bg-black/80 p-8 shadow-xl">
				...
				<div className="flex flex-col gap-4">
					<Link
						to="/demo/legacy/start/ssr/spa-mode"
					...
					<Link
						to="/demo/legacy/start/ssr/full-ssr"
					...
					<Link
						to="/demo/legacy/start/ssr/data-only"
