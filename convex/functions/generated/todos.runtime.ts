...
const procedureRegistry = {
	add: [
		...
		typedProcedureResolver(
			api["todos"]["add"],
			() => (require("../todos") as Record<string, unknown>)["add"],
		),
	],
	list: [
		"query",
		typedProcedureResolver(
			api["todos"]["list"],
			() => (require("../todos") as Record<string, unknown>)["list"],
		),
	],
	remove: [
		"mutation",
		typedProcedureResolver(
			api["todos"]["remove"],
			() => (require("../todos") as Record<string, unknown>)["remove"],
		),
	],
	toggle: [
		"mutation",
		typedProcedureResolver(
			api["todos"]["toggle"],
			() => (require("../todos") as Record<string, unknown>)["toggle"],
		),
	],
} as const;
